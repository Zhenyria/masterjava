...
public class MailWSClient {
    ...
    public static String sendToGroup(final Set<Addressee> to,
        ...
        String status = WS_CLIENT.getPort().sendToGroup(to, cc, subject, body, null);
    ...
    public static Set<Addressee> split(String addressees) {
        ...
        return ImmutableSet.copyOf(StreamSupport.stream(split.spliterator(), false)
                                                .map(Addressee::new)
